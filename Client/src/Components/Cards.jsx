...
:
            <div class="px-6">
                <div class="flex flex-wrap justify-center">
                        <div class="relative">
                            <img src={profile?.palabras?.image[posicion]} class="shadow-xl rounded-full align-middle border-none relative -m-16 -ml-20 lg:-ml-16 max-w-[150px]" />
                        </div>
                        </div>
                    <div class="w-full text-center mt-20">
                        <div class="flex justify-center lg:pt-4 pt-8 pb-0">
                            <div class="p-3 text-center">
                                <span class="text-xl font-bold block uppercase tracking-wide text-slate-700">{profile?.palabras?.ingles.length + profile?.aprendidas?.ingles.length}</span>
                                <span class="text-sm text-slate-400">Palabras</span>
                            </div>
                            <div class="p-3 text-center">
                                <span class="text-xl font-bold block uppercase tracking-wide text-slate-700">{profile?.aprendidas?.ingles.length}</span>
